...
@interface KTDefineView (KTPrivateMethods)
- (void)loadSubviewsWithFrame:(CGRect)frame;
- (BOOL)isZoomed;
@end

@implementation KTDefineView
...
{
    [backgroundView_ addSubview:backv];
}
- (void)dealloc 
{
...
- (void)loadSubviewsWithFrame:(CGRect)frame
{
   backgroundView_ = [[UIScrollView alloc] initWithFrame:frame];
   [backgroundView_ setContentMode:UIViewContentModeScaleAspectFit];
...
- (void)layoutSubviews
{
   ...
   if ([self isZoomed] == NO && CGRectEqualToRect([self bounds], [backgroundView_ frame]) == NO) {
...
{
   UIView *viewToZoom = backgroundView_;
   return viewToZoom;
}
...
- (void)setMaxMinZoomScalesForCurrentBounds
{
   ...
   CGSize imageSize = backgroundView_.bounds.size;
...
- (CGPoint)pointToCenterAfterRotation
{
   ...
   return [self convertPoint:boundsCenter toView:backgroundView_];
}
...
{    
   ...
   CGPoint boundsCenter = [self convertPoint:oldCenter fromView:backgroundView_];

...
-(void)halfSuccessStyle{
    [self bootstrapStyle];
    self.backgroundColor = [UIColor colorWithRed:92/255.0 green:184/255.0 blue:92/255.0 alpha:0.7];
    self.layer.borderColor = [[UIColor colorWithRed:76/255.0 green:174/255.0 blue:76/255.0 alpha:0.8] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:69/255.0 green:164/255.0 blue:84/255.0 alpha:0.7]] forState:UIControlStateHighlighted];
}
...
-(void)cancelStyle{
    ...
    self.layer.borderColor = [[UIColor colorWithRed:113/255.0 green:113/255.0 blue:113/255.0 alpha:1] CGColor];
    [self setBackgroundImage:[self buttonImageFromColor:[UIColor colorWithRed:133/255.0 green:133/255.0 blue:133/255.0 alpha:1]] forState:UIControlStateHighlighted];
}
